...
namespace Imperial_Commander_Editor
{
	...
	{
		string _thumbnailGroupImperial, _thumbnailGroupRebel, _modification, _repositionInstructions, _groupAttack, _groupDefense, _surges, _bonuses, _keywords, _abilities, _deploymentOutlineColor;
		...
		public string deploymentOutlineColor { get { return _deploymentOutlineColor; } set { _deploymentOutlineColor = value; PC(); } }
