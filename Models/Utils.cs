...
namespace Imperial_Commander_Editor
{
	public static class Utils
	{
		...
		public static List<DeploymentCard> customData { get; set; } = new();
		public static List<TileDescriptor> tileData { get; set; }
		public static ThumbnailData thumbnailData { get; set; }
		//public static List<CardInstruction> enemyInstructions { get; set; }
		//public static List<BonusEffect> enemyBonusEffects { get; set; }
		//public static List<MissionNameData> missionNames { get; set; }

		public static ObservableCollection<DeploymentColor> deploymentColors { get; set; }
